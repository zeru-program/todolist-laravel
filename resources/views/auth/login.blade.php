...
<div class="screen-1">
  ...
  <div class="footer"><span style="border-bottom:.5px solid #8C6EFF; padding:5px;" onclick="window.location.href = '/auth/register'">Register</span><span style="border-bottom:.5px solid #8C6EFF; padding:5px;">Forgot Password?</span></div>
</div>
<!-- partial -->
